...
<style>
  ...
  .icon {position: absolute; left:25%; z-index: 2; width: 50%; height: 53%; background: url("../assets/foot_icon.png") no-repeat; background-size: contain; background-position: center}
